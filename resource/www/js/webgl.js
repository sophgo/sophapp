...
WebGLPlayer.prototype.renderFrame = function (y_data, u_data, v_data, width, height) {
    if (!this.gl) {
    ...
    gl.y.fill(width, height, y_data);
    gl.u.fill(width >> 1, height >> 1, u_data);
    gl.v.fill(width >> 1, height >> 1, v_data);
