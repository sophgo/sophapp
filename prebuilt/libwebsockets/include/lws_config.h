...
#define LWS_INSTALL_DATADIR "/media/cvitek/kenneth.liu/Project/gitSrc/masterSDK/oss/install/libwebsockets/share"
#define LWS_INSTALL_LIBDIR "/media/cvitek/kenneth.liu/Project/gitSrc/masterSDK/oss/install/libwebsockets/lib"
